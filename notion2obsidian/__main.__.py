import argparse
import n2o
from n2o import notion2obsidian_nosubdir
...
def main() -> None:
  ...
  parser.add_argument('src', help='Notion exported md folder', type=str)

  parser.add_argument('-o', '--output', help='Obsidian md folder', default='', action='store')
  parser.add_argument('-l', '--delete-emptylines', help='Delete empty lines.', action='store_true')
